...
const DAYS = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "14:00頃", label: "100E エアポートエクスプレス 乗車", desc: "Deák Ferenc tér まで直通約40分・2,500HUF/人。予約不要・10〜15分間隔で運行。車内のクレカタッチ決済（Budapest Pay&GO）が最も手軽", icon: "🚌", coords: [47.4369, 19.2556] },
    ...
    memo: {
      ...
      body: (
        <>
          <b>100E エアポートエクスプレス（直通・推奨）</b>：Deák Ferenc tér 行き。約40分・専用券 2,500HUF/人。10〜15分間隔で頻発運行（24時間）。<br/>
          ...
          <b>混雑・満車の心配なし</b>：大型連節バスのため収容力が高く、座席指定制ではないため売り切れで乗れない心配はありません。万が一列が長くて混雑していても、10分程度待てばすぐ次のバスが来ます（座りたい場合は1本見送って先頭に並ぶと確実）。<br/>
