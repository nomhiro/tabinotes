...
const DAYS = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "09:00頃", label: "【理乃】広島駅着 → アパホテルに荷物を預ける", desc: "JR広島駅南口徒歩4分。チェックイン前でもフロントで荷物預かりOK。身軽になって宮島へ", icon: "🧳", mapUrl: "https://maps.google.com/?q=アパホテル+広島駅前大橋", coords: [34.3958, 132.4757] },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "08:45", label: "アパホテル チェックアウト・荷物を広島駅ロッカーへ", desc: "身軽になって出発。広島駅のコインロッカーが便利", icon: "🧳" },
      { time: "09:00", label: "世界平和記念聖堂（カトリック幟町教会）見学", desc: "村野藤吾設計、戦後建築で初めて重要文化財に指定された名建築。被爆・戦争犠牲者の追悼と世界平和祈願の聖堂。拝観9:00〜17:00・無料（内部は撮影禁止）。広電「銀山町」から徒歩4分／広島駅から徒歩約14分", icon: "⛪", important: true, url: "https://noboricho.catholic.hiroshima.jp/", mapUrl: "https://maps.google.com/?q=世界平和記念聖堂+カトリック幟町教会", coords: [34.3963, 132.4682] },
      { time: "10:15", label: "広島駅 → 呉駅（JR呉線）", desc: "快速「安芸路ライナー」で約40分。海沿いを走る呉線", icon: "🚃", important: true },
      { time: "11:00", label: "呉駅 到着", desc: "大和ミュージアム・鉄のくじら館ともに駅から徒歩約5分", icon: "🚉", coords: [34.2426, 132.5551] },
      { time: "11:15", label: "大和ミュージアム 見学", desc: "戦艦「大和」の1/10巨大模型と造船・科学技術の展示。2026年4月にリニューアル。9:00〜18:00（入館17:30まで）", icon: "🚢", important: true, url: "https://yamato-museum.com/", mapUrl: "https://maps.google.com/?q=大和ミュージアム", coords: [34.2410, 132.5556] },
          ...
          {activeDay === 1 && (
            <div style={{ background:"linear-gradient(135deg,#f0f7f2,#f5f9f0)", border:"1px solid #c8ddc5", borderRadius:"6px", padding:"1rem 1.2rem", marginBottom:"2rem", fontSize:".82rem", lineHeight:1.7, color:"#3a5a40" }}>
              ...
              <div>
                ...
                <b>帰りの移動</b>：<b>世界遺産航路（ガイド付き高速船）</b>で宮島桟橋→平和公園（元安桟橋）。約45分・大人¥2,200・<b>要予約</b>（TEL 082-240-5955）。原爆ドーム・おりづるタワーのすぐそばに着くので午後がスムーズ<br/>
                <b>宮島発 14時台の便</b>：14:20発→15:05着 ／ 14:45発→15:30着。<span style={{color:"#c0554e"}}>15:20発以降は潮位の影響で欠航予定＝14時台が実質最終便</span>（当日の運航表で要確認）<br/>
                <b>⚠ 御朱印</b>：広島護国神社は16:30まで。14:20発（15:05着）なら余裕を持って参拝できる
              </div>
            </div>
          )}
