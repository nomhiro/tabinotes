...
const DAYS = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "12:30", label: "鉄輪温泉街を散策", desc: "湯けむりの街並みを散歩。足湯や食べ歩きも楽しめる", icon: "🚶", mapUrl: "https://maps.google.com/?q=鉄輪温泉+別府", coords: [33.3160, 131.4475] },
      { time: "13:30", label: "明礬温泉エリアへ移動", desc: "鉄輪から国道500号で約5分", icon: "🚗" },
      { time: "13:35", label: "明礬地獄遊歩道（湯の花小屋見学）", desc: "江戸時代から続く湯の花製造の現場。藁葺きの小屋が約50棟並び、国の重要無形民俗文化財に指定", icon: "🌫", url: "https://yuno-hana.jp/", mapUrl: "https://maps.google.com/?q=明礬地獄+湯の花小屋", coords: [33.3026, 131.4316] },
      { time: "14:15", label: "岡本屋売店で地獄蒸しプリン", desc: "1988年から提供される元祖。ほろ苦カラメル＋なめらかプリン。L.O.17:30、店内利用は18:00まで", icon: "🍮", url: "https://jigoku-prin.com/", mapUrl: "https://maps.google.com/?q=岡本屋売店+明礬", coords: [33.3027, 131.4321] },
      { time: "14:50", label: "湯けむり展望台へ移動", desc: "明礬から鉄輪方面へ車で約10分", icon: "🚗" },
      { time: "15:00", label: "湯けむり展望台", desc: "鉄輪温泉郷の湯けむりを一望できる絶景スポット。日本夜景遺産にも認定", icon: "🌁", url: "https://www.city.beppu.oita.jp/sisetu/sangyou_kankou/yukemuri.html", mapUrl: "https://maps.google.com/?q=湯けむり展望台+別府", coords: [33.3138, 131.4513] },
      { time: "15:30", label: "ホテルチェックイン（荷物を預ける）", desc: "日本旅館 器 別府鉄輪｜荷物を置いて市街観光へ。温泉は食後に", icon: "🏨", mapUrl: "https://maps.google.com/?q=日本旅館+器+別府鉄輪", coords: [33.3165, 131.4485] },
      { time: "15:50", label: "別府市街（北浜）へ移動", desc: "県道218号〜国道10号経由で約20分", icon: "🚗" },
      { time: "16:15", label: "別府タワー", desc: "1957年竣工の昭和レトロ展望塔。地上100mから別府湾と鶴見岳を一望", icon: "🗼", mapUrl: "https://maps.google.com/?q=別府タワー", coords: [33.2872, 131.5066] },
      { time: "16:50", label: "竹瓦温泉エリア散策", desc: "明治4年創設・昭和13年築の歴史的銭湯。外観だけでも一見の価値あり。周辺のソルパセオ銀座（昭和レトロ商店街）や海門寺通りも合わせて散策", icon: "🏛", important: true, mapUrl: "https://maps.google.com/?q=竹瓦温泉+別府", coords: [33.2810, 131.5028] },
      { time: "17:50", label: "食道楽とさかへ徒歩で移動", desc: "竹瓦温泉から北浜方面へ徒歩約5分", icon: "🚶" },
