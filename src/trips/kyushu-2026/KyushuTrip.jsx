...
const DAYS = [
  {
    ...
    color: "#E8734A",
    icon: "⛴",
    weather: { name: "大阪", lat: 34.6937, lon: 135.5023, tripDate: "2026-05-05" },
    schedule: [
  ...
  },
  {
    ...
    color: "#D94F4F",
    icon: "♨",
    weather: { name: "別府", lat: 33.2803, lon: 131.5054, tripDate: "2026-05-06" },
    schedule: [
      ...
      { time: "12:40", label: "鉄輪温泉街を散策＋足湯", desc: "湯けむりの街並みを散歩。蒸し場・足湯・食べ歩きを楽しむ", icon: "🚶", mapUrl: "https://maps.google.com/?q=鉄輪温泉+別府", coords: [33.3160, 131.4475] },
      { time: "14:00", label: "明礬温泉エリアへ移動", desc: "鉄輪から国道500号で約5分", icon: "🚗" },
      { time: "14:05", label: "明礬地獄遊歩道（湯の花小屋見学）", desc: "江戸時代から続く湯の花製造の現場。藁葺きの小屋が約50棟並び、国の重要無形民俗文化財に指定", icon: "🌫", url: "https://yuno-hana.jp/", mapUrl: "https://maps.google.com/?q=明礬地獄+湯の花小屋", coords: [33.3026, 131.4316] },
      { time: "14:50", label: "岡本屋売店で地獄蒸しプリン", desc: "1988年から提供される元祖。ほろ苦カラメル＋なめらかプリン。店内でゆっくり味わう（L.O.17:30、店内利用は18:00まで）", icon: "🍮", url: "https://jigoku-prin.com/", mapUrl: "https://maps.google.com/?q=岡本屋売店+明礬", coords: [33.3027, 131.4321] },
      { time: "15:40", label: "湯けむり展望台へ移動", desc: "明礬から鉄輪方面へ車で約10分", icon: "🚗" },
      { time: "15:50", label: "湯けむり展望台", desc: "鉄輪温泉郷の湯けむりを一望できる絶景スポット。日本夜景遺産にも認定", icon: "🌁", url: "https://www.city.beppu.oita.jp/sisetu/sangyou_kankou/yukemuri.html", mapUrl: "https://maps.google.com/?q=湯けむり展望台+別府", coords: [33.3138, 131.4513] },
      { time: "16:30", label: "ホテルチェックイン", desc: "日本旅館 器 別府鉄輪｜荷物を置いて夕食前に少し休憩。温泉は食後に", icon: "🏨", mapUrl: "https://maps.google.com/?q=日本旅館+器+別府鉄輪", coords: [33.3165, 131.4485] },
      { time: "17:00", label: "鉄輪でお土産タイム", desc: "湯の花パウダー、地獄蒸しプリンの取り寄せ予約、鉄輪のせんべい等。夕食前の小休止", icon: "🛍", mapUrl: "https://maps.google.com/?q=鉄輪温泉+別府", coords: [33.3160, 131.4475] },
      { time: "17:30", label: "別府駅前（北浜）へ車で移動", desc: "県道218号〜国道10号経由で約20分。北浜のコインパーキングへ", icon: "🚗" },
      { time: "18:00", label: "食道楽とさか（夕食）", desc: "別府駅徒歩3分の居酒屋。佐伯港直送の鮮魚（関アジ・関サバ等）と大分郷土料理が名物。L.O.23:00／日曜定休。要予約 0977-75-9221（14時以降）", icon: "🍽", important: true, url: "https://tosaka-beppu.com/", mapUrl: "https://maps.app.goo.gl/uUpKUwaCfB6pk3EL8", coords: [33.2840, 131.5060] },
      { time: "20:30", label: "鉄輪温泉へ戻る", desc: "車で約20分。Day 3 は8:00出発のため早めに切り上げ", icon: "🚗" },
      { time: "20:55", label: "温泉でゆっくり", desc: "離れの露天岩風呂＆内湯で美人湯源泉100%かけ流しを満喫", icon: "♨" },
      { time: "22:00", label: "就寝", desc: "翌朝はやまなみハイウェイで大観峰へ。8:00出発", icon: "🌙" },
    ],
    booking: {
      title: "日本旅館 器 別府鉄輪",
      mapUrl: "https://maps.google.com/?q=日本旅館+器+別府鉄輪",
      details: [
        { label: "予約番号", value: "IY1554073380" },
        { label: "部屋", value: "離れ【利器-riki-喫煙室】露天岩風呂＆内湯付き" },
        { label: "食事", value: "食事なし（泊食分離スタイル）" },
        { label: "チェックイン", value: "15:00" },
        { label: "チェックアウト", value: "〜11:00" },
        { label: "住所", value: "大分県別府市鉄輪（別府温泉）" },
        { label: "料金", value: "¥20,234" },
      ],
    },
  },
  {
    ...
    color: "#3A8C6E",
    icon: "🌿",
    weather: { name: "阿蘇", lat: 32.8853, lon: 131.0741, tripDate: "2026-05-07" },
    schedule: [
      ...
      { time: "09:30", label: "大観峰", desc: "標高936mの阿蘇外輪山の最高峰。朝の澄んだ空気の中、360度の大パノラマで阿蘇五岳の涅槃像を望む。お土産店・食堂あり", icon: "⛰", important: true, mapUrl: "https://maps.google.com/?q=大観峰+阿蘇", coords: [33.0550, 131.0589] },
      { time: "10:15", label: "いまきん食堂へ", desc: "大観峰から約10分", icon: "🚗" },
      { time: "10:25", label: "いまきん食堂に到着・並ぶ", desc: "開店11:00の30分前に到着。大人気の赤牛丼の名店、平日でも行列必至", icon: "🍽", important: true, url: "http://aso-imakin.com/", mapUrl: "https://maps.google.com/?q=いまきん食堂+阿蘇", coords: [33.0281, 131.0711] },
      { time: "11:00", label: "赤牛丼ランチ", desc: "名物のあか牛丼。阿蘇の赤牛の旨みと温泉卵が絶品", icon: "🥩" },
      { time: "11:45", label: "阿蘇神社方面へ", desc: "内牧からカルデラ盆地を南下。約30分", icon: "🚗" },
      { time: "12:15", label: "阿蘇神社 ＆ 門前町散策", desc: "肥後国一の宮。復興した楼門は必見。門前町「仲町通り」で食べ歩き、湧水の水基めぐりを楽しむ", icon: "⛩", url: "https://asojinja.or.jp/", mapUrl: "https://maps.google.com/?q=阿蘇神社", coords: [32.9494, 131.1230] },
      { time: "13:00", label: "阿蘇パノラマラインを南へ", desc: "阿蘇山の山腹を走る絶景ルート。約30分", icon: "🚗" },
      { time: "13:30", label: "草千里ヶ浜", desc: "直径約1kmの大草原に馬が放牧される牧歌的風景。中岳の噴煙をバックに。乗馬体験も可能。阿蘇火山博物館も併設", icon: "🌿", important: true, mapUrl: "https://maps.google.com/?q=草千里ヶ浜", coords: [32.8914, 131.0661] },
  ...
  },
  {
    ...
    color: "#2B7A9E",
    icon: "🛶",
    weather: { name: "高千穂", lat: 32.7132, lon: 131.3070, tripDate: "2026-05-08" },
    schedule: [
  ...
  },
  {
    ...
    color: "#6B5CA5",
    icon: "✈",
    weather: { name: "熊本", lat: 32.8064, lon: 130.7057, tripDate: "2026-05-09" },
    schedule: [
    ...
    <div style={{ fontFamily: "'Noto Serif JP', 'Hiragino Mincho ProN', serif", background: "#F7F3ED", minHeight: "100vh", color: "#2C2421" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-bar { position:sticky; top:0; z-index:100; background:rgba(247,243,237,.92); backdrop-filter:blur(12px); border-bottom:1px solid rgba(0,0,0,.08); display:flex; justify-content:flex-start; overflow-x:auto; }
      ...
      <header className="cover">
        ...
        <div className="cover-content">
          ...
          <h1 className="cover-title">九州の旅</h1>
        ...
        <div className="day-section" key={`day-${activeDay}`}>
          ...
          {activeDay === 1 && (
            <div style={{ background:"linear-gradient(135deg,#fff5f5,#fff9f0)", border:"1px solid #f0ddd0", borderRadius:"6px", padding:"1rem 1.2rem", marginBottom:"2rem", fontSize:".82rem", lineHeight:1.7, color:"#5a4a40" }}>
              <h3 style={{ fontFamily:"'Zen Maru Gothic',sans-serif", fontWeight:700, fontSize:".88rem", marginBottom:".5rem", color:"#D94F4F", display:"flex", alignItems:"center", gap:".5rem", flexWrap:"wrap" }}>
                ♨ 地獄めぐりメモ
                <a href="https://www.beppu-jigoku.com/" target="_blank" rel="noopener noreferrer" className="memo-link" style={{ fontSize:".75rem", color:"#5a8a6e", textDecoration:"none", border:"1px solid #d4e8dc", padding:".15rem .5rem", borderRadius:"3px" }}><span aria-hidden="true">🌐</span> 公式サイト</a>
              </h3>
              <div>
                <b>共通観覧券</b>：¥2,400/人（7ヶ所入場可・2日間有効）<br/>
                → <a href="https://www.beppu-jigoku.com/discount/" target="_blank" rel="noopener noreferrer" className="memo-link" style={{ color:"#D94F4F" }}>公式HP割引クーポン</a>を印刷 or スマホ提示で<b>¥200引き</b><br/>
          ...
          {activeDay === 2 && (
            <div style={{ background:"linear-gradient(135deg,#f0f7f2,#f5f9f0)", border:"1px solid #c8ddc5", borderRadius:"6px", padding:"1rem 1.2rem", marginBottom:"2rem", fontSize:".82rem", lineHeight:1.7, color:"#3a5a40" }}>
              <h3 style={{ fontFamily:"'Zen Maru Gothic',sans-serif", fontWeight:700, fontSize:".88rem", marginBottom:".5rem", color:"#3A8C6E", display:"flex", alignItems:"center", gap:".5rem", flexWrap:"wrap" }}>
                ⛰ 阿蘇ドライブメモ
              </h3>
              <div>
          ...
          {activeDay === 3 && (
            <div style={{ background:"linear-gradient(135deg,#eef4fa,#f0f6fb)", border:"1px solid #c0d4e8", borderRadius:"6px", padding:"1rem 1.2rem", marginBottom:"2rem", fontSize:".82rem", lineHeight:1.7, color:"#2a4a6a" }}>
              <h3 style={{ fontFamily:"'Zen Maru Gothic',sans-serif", fontWeight:700, fontSize:".88rem", marginBottom:".5rem", color:"#2B7A9E", display:"flex", alignItems:"center", gap:".5rem", flexWrap:"wrap" }}>
                🛶 高千穂峡ボート予約メモ
                <a href="https://eipro.jp/takachiho1/eventCalendars/index" target="_blank" rel="noopener noreferrer" className="memo-link" style={{ fontSize:".75rem", color:"#2B7A9E", textDecoration:"none", border:"1px solid #c0d4e8", padding:".15rem .5rem", borderRadius:"3px" }}><span aria-hidden="true">🌐</span> 予約サイト</a>
              </h3>
              <div>
          ...
          {activeDay === 4 && (
            <div style={{ background:"linear-gradient(135deg,#f3f0f8,#f6f3fa)", border:"1px solid #cfc5e0", borderRadius:"6px", padding:"1rem 1.2rem", marginBottom:"2rem", fontSize:".82rem", lineHeight:1.7, color:"#3a2a5a" }}>
              <h3 style={{ fontFamily:"'Zen Maru Gothic',sans-serif", fontWeight:700, fontSize:".88rem", marginBottom:".5rem", color:"#6B5CA5", display:"flex", alignItems:"center", gap:".5rem", flexWrap:"wrap" }}>
                🏯 熊本城メモ
                <a href="https://castle.kumamoto-guide.jp/" target="_blank" rel="noopener noreferrer" className="memo-link" style={{ fontSize:".75rem", color:"#6B5CA5", textDecoration:"none", border:"1px solid #cfc5e0", padding:".15rem .5rem", borderRadius:"3px" }}><span aria-hidden="true">🌐</span> 公式サイト</a>
              </h3>
              <div>
          ...
          {(activeDay === 1 || activeDay === 4) && (
            <div className="booking-card" style={{ marginTop: "1.5rem" }} role="button" tabIndex={0}
              aria-expanded={expandedBooking === "rental"}
              onClick={() => setExpandedBooking(expandedBooking === "rental" ? null : "rental")}
              onKeyDown={e => handleCardKeyDown(e, () => setExpandedBooking(expandedBooking === "rental" ? null : "rental"))}>
              <div className="booking-header" style={{ borderLeft: "3px solid #555" }}>
                <span><span aria-hidden="true">🚗</span> {RENTAL_CAR.title}（全行程）</span>
                <span className="booking-toggle" aria-hidden="true" style={{ transform: expandedBooking === "rental" ? "rotate(180deg)" : "none" }}>▼</span>
              </div>
