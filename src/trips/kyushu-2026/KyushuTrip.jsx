...
const DAYS = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "15:00", label: "ホテルチェックイン", desc: "日本旅館 器 別府鉄輪", icon: "🏨", mapUrl: "https://maps.google.com/?q=日本旅館+器+別府鉄輪", coords: [33.3165, 131.4485] },
      { time: "15:30", label: "温泉でゆっくり", desc: "離れの露天岩風呂＆内湯で美人湯源泉100%かけ流しを満喫", icon: "♨" },
  ...
  },
  {
    day: 3,
    date: "5月7日（木）",
    title: "やまなみハイウェイ → いまきん食堂 → 阿蘇絶景ドライブ",
    color: "#3A8C6E",
    icon: "🌿",
    schedule: [
      { time: "〜09:00", label: "チェックアウト", desc: "日本旅館 器 別府鉄輪｜いまきん食堂の開店前に並ぶため早めに出発", icon: "🏨" },
      { time: "09:00", label: "やまなみハイウェイで阿蘇へ", desc: "別府から阿蘇・内牧まで約1時間半の絶景ドライブ。くじゅう連山や草原の中を走る", icon: "🚗" },
      { time: "10:30", label: "いまきん食堂に到着・並ぶ", desc: "開店11:00の30分前に到着。大人気の赤牛丼の名店、平日でも行列必至", icon: "🍽", important: true, url: "http://aso-imakin.com/", mapUrl: "https://maps.google.com/?q=いまきん食堂+阿蘇", coords: [33.0281, 131.0711] },
      { time: "11:00", label: "赤牛丼ランチ", desc: "名物のあか牛丼。阿蘇の赤牛の旨みと温泉卵が絶品", icon: "🥩" },
      { time: "11:45", label: "大観峰へ", desc: "内牧から大観峰まで約15分", icon: "🚗" },
      { time: "12:00", label: "大観峰", desc: "標高936mの阿蘇外輪山の最高峰。360度の大パノラマで阿蘇五岳の涅槃像を望む。お土産店・食堂あり", icon: "⛰", important: true, mapUrl: "https://maps.google.com/?q=大観峰+阿蘇", coords: [33.0550, 131.0589] },
      { time: "12:45", label: "カルデラ内へ下る", desc: "大観峰からカルデラ盆地へ。約20分", icon: "🚗" },
      { time: "13:00", label: "阿蘇神社 ＆ 門前町散策", desc: "肥後国一の宮。復興した楼門は必見。門前町「仲町通り」で食べ歩き、湧水の水基めぐりを楽しむ", icon: "⛩", url: "https://asojinja.or.jp/", mapUrl: "https://maps.google.com/?q=阿蘇神社", coords: [32.9494, 131.1230] },
      { time: "13:45", label: "阿蘇パノラマラインを南へ", desc: "阿蘇山の山腹を走る絶景ルート。約30分", icon: "🚗" },
      { time: "14:15", label: "草千里ヶ浜", desc: "直径約1kmの大草原に馬が放牧される牧歌的風景。中岳の噴煙をバックに。乗馬体験も可能。阿蘇火山博物館も併設", icon: "🌿", important: true, mapUrl: "https://maps.google.com/?q=草千里ヶ浜", coords: [32.8914, 131.0661] },
      { time: "15:00", label: "阿蘇中岳火口（規制状況次第）", desc: "直径600m・深さ130mの火口から噴き上がる白煙は圧巻。※火山活動により立入規制の場合あり。事前に要確認", icon: "🌋", url: "https://www.aso.ne.jp/~volcano/", mapUrl: "https://maps.google.com/?q=阿蘇中岳火口", coords: [32.8842, 131.0843] },
      { time: "15:45", label: "南阿蘇方面へ", desc: "中岳から休暇村 南阿蘇まで約30分", icon: "🚗" },
      { time: "16:15", label: "ホテルチェックイン", desc: "休暇村 南阿蘇", icon: "🏨", mapUrl: "https://maps.google.com/?q=休暇村+南阿蘇", coords: [32.8553, 131.1367] },
